	...
	$(function(){
		...
		$("#editBtn").click(function () {
			...
			//肯定只选了一条
				...
				$.ajax({
					url : "workbench/activity/getUserListAddActivity.do",
					data : {
						"id" : id
					},
					type : "get",
					...
					<form class="form-horizontal" role="form">
						...
						<div class="form-group">
							...
							<div class="col-sm-10" style="width: 81%;">
								<%--
									关于文本域textarea:
										1.一定是以标签对的形式来呈现,正常状态下标签对要紧紧的挨着
										2.textatea虽然是以标签对的形式来呈现,但是它也是属于表单元素范畴
