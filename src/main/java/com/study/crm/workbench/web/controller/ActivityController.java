...
public class ActivityController extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        }else if ("/workbench/activity/getUserListAddActivity.do".equals(path)){
            getUserListAddActivity(request,response);
    ...
    private void getUserListAddActivity(HttpServletRequest request, HttpServletResponse response) {
    ...
    private void pageList(HttpServletRequest request, HttpServletResponse response) {
        ...
        /*
            前端要: 市场活动信息列表
                   ...
                   PaginationVO<Activity> vo = nwe PaginationVO<>;
                   co.setTotal(total);
